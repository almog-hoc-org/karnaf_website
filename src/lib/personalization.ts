...
export const CONCERN_COPY: Record<QuizConcern, ConcernCopy> = {
  overpay: {
    pricingLine:
      "אמרתם שהפחד הגדול הוא לשלם יותר מדי — זה בדיוק מה שהמחשבון שמשווה עסקאות שנסגרו באותו רחוב נועד למנוע.",
    testimonial: NOAM,
    closingLine:
  ...
  mortgage: {
    pricingLine:
      "אמרתם שמשכנתאות זה מה שהכי לא ברור — מודול המימון והמחשבונים בנויים בדיוק בשביל להגיע לבנק כלקוח שיודע מה הוא מבקש.",
    testimonial: ROTEM,
    closingLine:
  ...
  negotiation: {
    pricingLine:
      "אמרתם שמשא ומתן זה מה שמלחיץ — מודול המו״מ מלמד להיכנס לשיחה עם נתונים במקום עם תחושת בטן.",
    testimonial: NOAM,
    closingLine:
