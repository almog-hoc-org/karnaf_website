      ...
      <motion.div
        ...
        <motion.div
          ...
          <img
            ...
            style={{
              maskImage: "linear-gradient(to top, transparent 0%, black 15%, black 55%, transparent 85%), linear-gradient(to right, transparent 0%, black 10%, black 90%, transparent 100%)",
              WebkitMaskImage: "linear-gradient(to top, transparent 0%, black 15%, black 55%, transparent 85%), linear-gradient(to right, transparent 0%, black 10%, black 90%, transparent 100%)",
