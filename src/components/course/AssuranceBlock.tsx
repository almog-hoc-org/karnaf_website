...
const assurances = [
  {
    icon: Eye,
    title: "אין הפתעות",
    body: "כל שיעור, כל כלי, כל דקה — כתובים כאן למעלה. מה שראיתם זה בדיוק מה שתקבלו.",
  },
  {
    icon: CalendarClock,
    title: "שנה שלמה, בקצב שלכם",
    body: "לא צריך לסיים החודש. 12 חודשי גישה — גם אם הדירה תגיע רק באביב.",
  },
  {
    icon: MessageCircle,
    title: "שאלה לפני שמחליטים?",
    body: "כתבו לנו בוואטסאפ. עונים כמו בני אדם, בלי לחץ מכירתי.",
    href: "whatsapp",
  },
];
