...
|---|---|---|
| `צ׳קליסט ביקור בנכס — בקשה מהאתר` | חלון היציאה (exit-intent) בדף הקורס | לשלוח את קובץ הצ׳קליסט (PDF), לסווג ב-CRM כ**ליד מגנט — צ׳קליסט**, ולתייג לנרטור המשך (מתעניין שלא רכש) |
...
> כשיהיה שיעור לדוגמה מוקלט — הוא יחליף/יתלווה לצ׳קליסט באותו הקשר.
